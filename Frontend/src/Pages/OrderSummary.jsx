        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <form>
              ...
              <div className="flex flex-col sm:flex-row">
                  ...
                  <input type="text" name="zip" className="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/6 focus:z-10 focus:border-blue-500 focus:ring-blue-500" onChange={(e) => setpayHereFormData({ ...payHereFormData, zip: e.target.value })} placeholder="ZIP"  required/>
              </div><br />
