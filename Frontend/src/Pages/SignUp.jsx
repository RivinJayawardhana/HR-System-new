    ...
    return (
        ...
        >
            <div className="p-6 max-w-lg w-full bg-white bg-opacity-80 rounded-lg shadow-lg ">
                ...
                <form className="grid grid-cols-2 md:grid-cols-2 gap-4  " onSubmit={handleSubmit}>
                    <div>
                    ...
                    <div>
                        ...
                        <TextInput type="text" placeholder="IT Number" id="itnumber" onChange={handleChange} />
                    </div>
                    <div>
                        <Label value="Distance To Campus" />
                        <TextInput type="text" placeholder="Distance To Campus" id="distance" onChange={handleChange} />
                    </div>
                    <div>
                        <Label value="Your Accademic Year" />
                        <TextInput type="text" placeholder="Accademic Year" id="acYear" onChange={handleChange} />
                    </div>
                    <div>
                        <Label value="Mode Of Transport" />
                        <TextInput type="text" placeholder="Mode Of Transport" id="mode" onChange={handleChange} />
                    </div>
                    <div>
                        <Label value="Degree Programme" />
                        <TextInput type="text" placeholder="Degree Programme" id="degree" onChange={handleChange} />
                    </div>
                    <div>
